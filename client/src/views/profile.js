                        ...
                        <div class="space-y-5 mt-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id ="current-password" type="password" name="current-password" placeholder="••••••••" class="w-full pl-9 pr-3.5 py-2.5 rounded-lg border border-slate-200 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
