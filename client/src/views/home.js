export function home() {
  ...
  <header class="relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 pt-14 pb-16 sm:pt-20 sm:pb-24 grid grid-cols-1 gap-12 items-center">
      <div>
        ...
        <div class="flex flex-wrap items-center gap-x-8 gap-y-3 mt-9">
          <div>
            <p id="total-reports" class="text-2xl font-extrabold text-slate-800"></p>
            <p class="text-xs text-slate-500">Reportes creados</p>
          </div>
          <div>
            <p id="solved-reports" class="text-2xl font-extrabold text-slate-800"></p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-infraestructura" class="text-[11px] text-slate-400 mt-1"></p>
        </div>
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-alumbrado" class="text-[11px] text-slate-400 mt-1"></p>
        </div>
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-limpieza" class="text-[11px] text-slate-400 mt-1"></p>
        </div>
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-movilidad" class="text-[11px] text-slate-400 mt-1"></p>
        </div>
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-servicios" class="text-[11px] text-slate-400 mt-1">20 reportes</p>
        </div>
        <div class="text-center border border-slate-100 rounded-2xl p-4 hover:shadow-card hover:border-blue-200 transition">
          ...
          <p id="count-seguridad" class="text-[11px] text-slate-400 mt-1">10 reportes</p>
        </div>
      </div>
